<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($input['folio']) && isset($input['nombre']) && isset($input['precio']) && isset($input['ubicacion'])) {
            $sql = "INSERT INTO clientes (folio, Nombre, precio, ubicacion) VALUES (:folio, :nombre, :precio, :ubicacion)";
